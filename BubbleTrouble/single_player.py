...
class SimMoveDemo1(QMainWindow):
    ...
    def __init__(self, zivot1, zivot2, poeni1, poeni2, slika, level, pic_no, speed):
        ...
        self.__init_ui__(zivot1, zivot2, poeni1, poeni2, slika, level, pic_no, speed)
